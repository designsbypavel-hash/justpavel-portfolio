      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mb-28 flex flex-col gap-12 lg:flex-row lg:items-start lg:gap-16">
          ...
          <div className="flex-1">
            ...
            <p className="text-lg leading-relaxed text-white/50">
              My work is driven by <strong className="font-semibold text-white">curiosity and systems thinking</strong>, with a belief that the best design removes friction without drawing attention to itself. I&rsquo;ve led UX across <strong className="font-semibold text-white">AI platforms and consumer products</strong> reaching{" "}
              <strong className="font-semibold text-white">350M+ users</strong>, and spent{" "}
        ...
        <div className="mb-28">
          ...
          <div className="space-y-5 text-lg leading-relaxed text-white/50">
            <p>
              Good design isn&rsquo;t just a clean layout. It&rsquo;s <strong className="font-semibold text-white">simplifying complex problems</strong>, giving information clear structure, and building something people understand at a glance, whether that&rsquo;s an AI platform, an <strong className="font-semibold text-white">enterprise SaaS workflow</strong>, or a conversion-focused mobile journey.
            </p>
            <p>
              Design doesn&rsquo;t happen in a vacuum. There&rsquo;s usually an existing backend, a tight timeline, incomplete information, or a product direction that&rsquo;s still evolving. <strong className="font-semibold text-white">Working well inside those constraints</strong>, not around them, is most of the job.
            </p>
            <p>
              I care about <strong className="font-semibold text-white">accessible, scalable design</strong>, not just beautiful screens.
            </p>
          </div>
        </div>
